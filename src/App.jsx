...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3) {
      const intervalId = setInterval(() => {
        setCurrentGifIndex(
          (prevIndex) => (prevIndex + 1) % YesGifs.length
        );
      }, 5000);
  ...
  const handleNoClick = () => {
    ...
    if (nextCount === 1 || (nextCount - 1) % 7 === 0) {
      const nextSongIndex =
        Math.floor(nextCount / 7) % NoMusic.length;
  ...
  const playMusic = (url, musicArray) => {
    ...
    audio.addEventListener("ended", () => {
      ...
      const nextIndex =
        (currentIndex + 1) % musicArray.length;
  ...
  const getNoButtonText = () => {
    const phrases = [
      ...
      "Сүүлчийн боломж шүү!",
      "Үнэхээр үгүй гэж үү? 🥺",
      "Дараа нь харамсаж магадгүй шүү!",
      "Дахиад нэг бодоод үзээч!",
      "Чи үнэхээр итгэлтэй байна уу?",
      "Энэ чинь алдаа байж магадгүй шүү!",
      "Чамд зүрх байгаа биз дээ! 💕",
      "Битгий ингэж хүйтэн хандаач!",
      "Дахин бодож үзэхгүй юу?",
      "Энэ чиний эцсийн хариулт мөн үү?",
      "Чи миний зүрхийг шархлуулж байна ;(",
      "Гэхдээ... яагаад? 😢",
      "Гуйя, гуйя даа? 💖",
      "Би үүнийг тэсэж чадахгүй нь! 😫",
      "Чи надад ингэх гэж байгаа юм уу? 😢",
      "Чи миний сэтгэлийг шархлуулна шүү! 😥",
      "Яг одоо дахиад нэг бодож үзээч! 😓",
      "Би чамд итгэж байна, намайг битгий урам хугал! 💔",
      "Миний зүрх 'Тийм' гэж байна, харин чинийх? ❤️",
      "Намайг ингэж хүлээлгэж битгий орхиоч! 😬",
      "Гуйяа? :( Чи миний зүрхийг шархлуулж байна 💔",
    ];
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title:
          "Би чамд маш их хайртай!!! ❤️ Чи миний зүрхийг тэр чигт нь булаачихсан!!! 🥰💖 Гэхдээ ийм хөөрхөн охин ийм хурдан зөвшөөрөх гэж үү? 🥰✨ Жаахан эрхлээд, намайг дахиад жаахан хүлээлгээч дээ! ❤️",
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3 && !yespopupShown) {
      Swal.fire({
        title:
          "Би чамд маш их хайртай!! ❤️ Чи бол миний бүх зүйл, миний баяр баясгалан, миний үүрд хамт байх хүн. Чамтай өнгөрүүлсэн хором бүр миний нандигнан хадгалах дурсамж байх болно. Миний зүрх зөвхөн чиний төлөө цохилдог. ❤️<br/><br/>Чи үүрд миний амьдралын хайр болох уу? 🥹❤️",
  ...
  useEffect(() => {
    if (noCount == 25) {
      Swal.fire({
        title:
          "Чамайг гэсэн миний хайр тэнгэр дэх одод шиг хязгааргүй — чи үргэлж анзаардаггүй байсан ч би шөнө бүр чиний төлөө гэрэлтсээр байх болно. 🌟 Би чамайг тэвчээртэй хүлээж, өдөр бүр чи миний хувьд ямар үнэ цэнтэй хүн болохыг харуулах болно. ❤️ 'Тийм' дээр дараад, хамтдаа үүрдийн хайрын түүхээ эхлүүлье. 🥰✨<br/><br/>'Жинхэнэ хайр хэзээ ч бууж өгдөггүй, цаг хугацаа өнгөрөх тусам улам хүчтэй болдог.' ❤️",
    ...
    <>
      ...
      <div className="overflow-hidden flex flex-col items-center justify-center pt-4 h-screen -mt-16 selection:bg-rose-600 selection:text-white text-zinc-900">
        ...
        {yesPressed && noCount > 3 ? (
          ...
          <>
            ...
            <img
              ...
              className="h-[230px] rounded-lg"
              src={Lovegif}
              alt="Хайрын хөдөлгөөнт зураг"
            />

            <h1 className="text-4xl md:text-6xl my-4 text-center">
              Чи миний Валентин болох уу? ❤️
            </h1>
            ...
            {floatingGifs.map((gif) => (
              <img
                key={gif.id}
                src={gif.src}
                alt="Хөвөгч хайрын хөдөлгөөнт зураг"
        ...
        <button
          ...
          onClick={toggleMute}
          aria-label={isMuted ? "Дууг асаах" : "Дууг хаах"}
        >
          {isMuted ? (
...
const Footer = () => {
  return (
    <a
      ...
      href="https://youtu.be/COkhi-Ae-sA?si=LUZF9Wzos66c81Xx"
      target="_blank"
      rel="noopener noreferrer"
    >
      <span>
        ❤️ Чиний өндөр залуу ❤️
      </span>
    </a>
  );
};
